...
State-scale **forest/non-forest map** for Alabama at **10 m** (target year **2025**). Sentinel-2 + Sentinel-1 + slope → RF → probability + binary. Labels: NLCD (baseline) or NAIP points/polygons. See [SCOPE.md](SCOPE.md) and [DIRECTION.md](DIRECTION.md).

**Docs**
- [SCOPE.md](SCOPE.md) — in/out of scope, artifacts
